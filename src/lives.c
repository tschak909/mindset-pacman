...
void lives_display(unsigned char p)
{
  ...
  unsigned char l=num_lives[p];
  
  lives_bp[ 0]=(l>1 ? FP_OFF(pacman_left_1) : FP_OFF(blank));
  lives_bp[ 1]=(l>1 ? FP_SEG(pacman_left_1) : FP_SEG(blank));
  ...
  lives_bp[10]=(l>2 ? FP_OFF(pacman_left_1) : FP_OFF(blank));
  lives_bp[11]=(l>2 ? FP_SEG(pacman_left_1) : FP_SEG(blank));
  ...
  lives_bp[20]=(l>3 ? FP_OFF(pacman_left_1) : FP_OFF(blank));
  lives_bp[21]=(l>3 ? FP_SEG(pacman_left_1) : FP_SEG(blank));
  ...
  lives_bp[30]=(l>4 ? FP_OFF(pacman_left_1) : FP_OFF(blank));
  lives_bp[31]=(l>4 ? FP_SEG(pacman_left_1) : FP_SEG(blank));
...
{
  num_lives[0]=num_lives[1]=MAX_LIVES;
}
